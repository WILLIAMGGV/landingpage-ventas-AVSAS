...
<div className="flex flex-row place-content-center mt-[350px]">
    ...
    <div className="hidden sm:flex-row sm:place-content-center place-content-center">
      ...
      <div className="piedepagina">
        ...
        <div style={{ fontFamily: "pextrabold", letterSpacing: "6px", color: 'white' }} className=" pt-[150px] text-[32px] flex flex-row place-content-center items-center justify-center"><a className='flex flex-row place-content-center' href='https://www.instagram.com/01.asistentevirtual/' target='_blank'><span className='mt-2'><svg class="w-[32px] h-[32px] text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div className="relative p-1 flex-auto">
                  <div className="p-1 md:p-1 text-center">
                    <div>
                      ...
                      <div id="gracias" className="text-[12px]  text-[#000033] sm:text-[24px] mt-10 flex flex-row place-content-center" style={{fontFamily: 'pextrabold'}}>
                      ¡Muy pronto nos comunicaremos contigo! Tu plantilla editable para la gestión del tiempo se descargará en un momento.
            </div>
  
            <div id="gracias2" className="text-[12px] w-[100%] text-blue-800 sm:text-[18px] text-center mt-10" style={{fontFamily: 'pextrabold'}}>
