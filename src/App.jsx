...
function App() {
  ...
  const guardar2 = async () => {
    ...
    // Obtener los valores de los campos de entrada
    const data = {
      nombre: document.getElementById("nombremobil").value,
      apellido: document.getElementById("apellidomobil").value,
      telefono: document.getElementById("telefonomobil").value,
      email: document.getElementById("emailmobil").value,
    };
